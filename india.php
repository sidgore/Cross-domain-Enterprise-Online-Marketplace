  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'india'},function(d){
                                    if(d>0)
                                    {
...
<p>
      ...
      <br/>
            ...
            <img src="images/india.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=india" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='india' and t.product='india'";
...
$sql1 = "SELECT user FROM products_visited  where product ='india' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'india',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='india' and user = '".$login_session."'" ;    
