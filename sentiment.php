  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'sentimentalist'},function(d){
                                    if(d>0)
                                    {
  ...
  <section>
    ...
    <div class="col-lg-2"></div>
     ...
     <p>Hello <?php echo $login_session; ?>, you have seen this page <?php echo $_SESSION['count']; ?> times.
      ...
      <p>
      <h2><code>Sentimentalist<span class="glyphicon glyphicon-fire"></span></h2></code> </p><br>
      <p class="bg-danger">Social media sentimental analysis
      </p>  </h2></p></p></blockquote>
      <img src="sentiment.png" class="img-fluid" alt="Responsive image">
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=sentimentalist" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='sentimentalist' and t.product ='sentimentalist'";
...
$sql1 = "SELECT user FROM products_visited  where product ='sentimentalist' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'sentimentalist',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='sentimentalist' and user = '".$login_session."'" ;    
