  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'jerseys'},function(d){
                                    if(d>0)
                                    {
...
<div id="jerseys"  class="container-fluid text-center formfont bg-grey ">
  ...
  <h2>JERSEYS</h2>
  <h4>Support and flaunt your favourite club, with your favourite players name on the back!</h4>
  <br><br>
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="cristianoronaldo.jpg" alt="Training" class="img-responsive">
        <p><strong>7 RONALDO - REAL MADRID</strong></p>
        <p>The all new Ronaldo jersey</p>
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="lionelmessi.jpg" alt="Training" class="img-responsive">
        <p><strong>10 MESSI - BARCELONA</strong></p>
        <p>The all new Messi jersey</p>
        <p>Season 2016-2017</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="zlatanibrahimovic.jpg" alt="Training" class="img-responsive">
        <p><strong>9 IBRAHIMOVIC - MANCHESTER UNITED</strong></p>
        <p>The all new Ibrahimovic jersey</p>
        <p>Season 2016-2017</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
...
<div class="row">
  ...
  <div class="col-sm-4 form-group">
                    <form action ="comment.php?product=jerseys" method="POST">
...
<center>
  ...
  $sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='jerseys' and t.product ='jerseys'";
 ...
 $sql1 = "SELECT user FROM products_visited  where product ='jerseys' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'jerseys',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='jerseys' and user = '".$login_session."'" ;    
