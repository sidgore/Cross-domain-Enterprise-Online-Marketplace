  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'nepal'},function(d){
                                    if(d>0)
                                    {
...
<img src="images/nepal.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=nepal" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='nepal'and t.product='nepal'";
...
$sql1 = "SELECT user FROM products_visited  where product ='nepal' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'nepal',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='nepal' and user = '".$login_session."'" ;    
