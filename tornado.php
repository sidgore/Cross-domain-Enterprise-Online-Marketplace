  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'tornado'},function(d){
                                    if(d>0)
                                    {
...
<div class="container">
	<section>
     ...
     <p>Hello <?php echo $login_session; ?>, you have seen this page <?php echo $_SESSION['count']; ?> times.
			...
			<p>
			<h2><code>Tornado<span class="glyphicon glyphicon-fire"></span></h2></code> </p><br>
			<p class="bg-danger">Tornado predictor!
			</p>	</h2></p></p></blockquote>
			<img src="tornado.jpg" class="img-thumbnail" alt="Responsive image">
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=tornado" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='tornado' and t.product ='tornado'";
...
$sql1 = "SELECT user FROM products_visited  where product ='tornado' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'tornado',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='tornado' and user = '".$login_session."'" ;    
