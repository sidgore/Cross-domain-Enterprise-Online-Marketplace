  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'england'},function(d){
                                    if(d>0)
                                    {
...
<p>
      <h2><code>England</h2></code> </p><br><p>
...
Here’s why: Travel creates memories that last a lifetime, and empowers your friends and family to grow through new sights, tastes, sounds, and experiences. Plus, it never goes out of style.
      ...
      <br/>
            ...
            <img src="images/england.jpg" height="300"   />
    <br><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=england" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='england' and t.product='england'";
...
$sql1 = "SELECT user FROM products_visited  where product ='england' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'england',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='england' and user = '".$login_session."'" ;    
