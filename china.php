  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'china'},function(d){
                                    if(d>0)
                                    {
     ...
     <p>Hello <?php echo $login_session; ?>, you have seen this page <?php echo $_SESSION['count']; ?> times.
      ...
      <h2><code>China</h2></code> </p><br><p>
       The ancient treasures and modern wonders of China span 5,000 years of culture and history. The natural beauty, fascinating heritage, mouth-watering cuisine, and state-of-the-art cities will enthrall, excite and amaze you. And throughout this great destination, a warm and friendly people awaits you, eager to share a level of hospitality that cannot be found anywhere else in the world. Now is the time to discover beautiful China, like never before! - 
        ...
        <img src="images/china.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=china" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='china' and t.product ='china'";
...
$sql1 = "SELECT user FROM products_visited  where product ='china' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'china',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='china' and user = '".$login_session."'" ;    
