...
<html> 
  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'singapore'},function(d){
                                    if(d>0)
                                    {
 ...
 <div class="row text-center">
  ...
  <p>
      <h2><code>Singapore</h2></code> </p><br><p>
       Think you know what SIngapore is all about? Whether you're a repeat visitor or heading here for the first time, the multi-faceted city unveils  layers of character with its intriguing contrasts.It is also environmentally friendly, and maintains natural and heritage conservation programs.
      </p>  <br>
      </p>  </h2></p></p></blockquote>
      <br/><br/>
        
<img src="images/singapore.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=singapore" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='singapore' and t.product ='singapore'";
...
$sql1 = "SELECT user FROM products_visited  where product ='singapore' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'singapore',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='singapore' and user = '".$login_session."'" ;    
