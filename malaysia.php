...
<html> 
  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'malaysia'},function(d){
                                    if(d>0)
                                    {
 ...
 <div class="row text-center">
    ...
    <p>
      <h2><code>Malaysia</h2></code> </p><br><p>
...
<img src="images/malaysia.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=malaysia" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='malaysia' and t.product='malaysia'";
...
$sql1 = "SELECT user FROM products_visited  where product ='malaysia' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'malaysia',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='malaysia' and user = '".$login_session."'" ;    
