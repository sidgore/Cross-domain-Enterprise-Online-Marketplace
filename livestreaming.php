  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'livestreaming'},function(d){
                                    if(d>0)
                                    {
...
<div id="services"  class="container-fluid text-center formfont bg-grey ">
  ...
  <span class="glyphicon glyphicon-hd-video logo-small"></span>
  <h2>LIVE STREAMING</h2>
  <h4>Never miss out on any action. Live coverage of games from all over the world!</h4>
  <br><br>
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="premierleague.jpg" alt="Training" class="img-responsive">
        <p><strong>LIVE STREAMING - BARCLAYS PREMIER LEAGUE</strong></p>
        <p>Watch the live streaming of all the games of the Barclays Premier League </p>
        <p>Barclays premier league is the ELite club compettition where the top English teams compete for the coveted title of Champions of England.</p>
        <p>Grab it for $59.99 per year</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="uefachampionsleague.jpg" alt="Training" class="img-responsive">
        <p><strong>LIVE STREAMING - UEFA CHAMPIONS LEAGUE</strong></p>
        <p>Watch the live streaming of all the games of the UEFA Champions league</p>
        <p>This is the biggest price of them all, top teams from the top leagues in Europe compete for the title of being called the best club in Europe and possibly the world.</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="spanishlaliga.jpg" alt="Training" class="img-responsive">
        <p><strong>LIVE STREAMING - SPANISH LA LIGA</strong></p>
        <p>Watch the live streaming of all the games of the Spanish La Liga</p>
        <p>Spanish La Liga is the Elite CLub competition where the top Spanish teams compete for the coveted title of Champions of Spain.</p>
        <p>Grab it for $39.99</p>
      </div>
    </div>
</div>
...
<div class="row">
  ...
  <div class="col-sm-4 form-group">
                    <form action ="comment.php?product=livestreaming" method="POST">
...
<center>
  ...
  $sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='livestreaming' and t.product ='livestreaming'";
 ...
 $sql1 = "SELECT user FROM products_visited  where product ='livestreaming' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'livestreaming',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='livestreaming' and user = '".$login_session."'" ;    
