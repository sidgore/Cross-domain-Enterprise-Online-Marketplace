...
<html> 
  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'srilanka'},function(d){
                                    if(d>0)
                                    {
 ...
 <div class="row text-center">
    ...
    <p>
      <h2><code>Sri Lanka</h2></code> </p><br><p>
...
Sri Lanka is still largely untouched and unchanged by mass Western tourism, but the word is getting out. Don't miss your chance to be the first to visit this place.
      </p>  <br>
      </p>  </h2></p></p></blockquote>
      <br/>

<img src="images/srilanka.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=srilanka" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='srilanka' and t.product='srilanka'";
...
$sql1 = "SELECT user FROM products_visited  where product ='srilanka' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'srilanka',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='srilanka' and user = '".$login_session."'" ;    
