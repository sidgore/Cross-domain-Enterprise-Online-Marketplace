  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'usa'},function(d){
                                    if(d>0)
                                    {
...
<p>
      <h2><code>United States of America</h2></code> </p><br><p>
...
Red double-decker tour buses have begun rolling again in New York and Circle Line boats have started plying the waterways as tourism took a few more baby steps toward normalization after the super storm Sandy, AP reports. The Empire State Building, Broadway theaters, the Museum of Modern Art and Metropolitan Museum, and many stores, have reopened. But the wire service says city parks (including Central Park), the High Line and the Statue of Liberty remain closed pending damage assessment . . . . Enjoy nibbles from top chefs and specialty food companies at the San Diego Bay Wine & Food Festival
      </p>  <br>
      </p>  </h2></p></p></blockquote>
      <br/>

<img src="images/usa.jpg" height="300"   />
    <br/><br/>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=usa" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='usa' and t.product='usa'";
...
$sql1 = "SELECT user FROM products_visited  where product ='usa' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'usa',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='usa' and user = '".$login_session."'" ;    
