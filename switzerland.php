  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'switzerland'},function(d){
                                    if(d>0)
                                    {
...
<p>
      <h2><code>Switzerland</h2></code> </p><br><p>
      Grüezi. Bonjour. Buongiorno. Allegra.
In winter, everyone is #INLOVEWITHSWITZERLAND as you can do all you want – but don’t have to. You’ll find both action and relaxation on superb pistes, in boutique cities and at gorgeous accommodation. Whatever your winter dreams, Switzerland has experiences to match!
      </p>  <br>
      </p>  </h2></p></p></blockquote>
      <br/>

        
<img src="images/switzerland.jpg" height="300"   />
    <br><br>
         <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=switzerland" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='switzerland' and t.product='switzerland'";
...
$sql1 = "SELECT user FROM products_visited  where product ='switzerland' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'switzerland',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='switzerland' and user = '".$login_session."'" ;    
