  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'accessories'},function(d){
                                    if(d>0)
                                    {
...
<div id="accessories"  class="container-fluid text-center formfont bg-grey ">
  ...
  <h2>ACCESSORIES</h2>
  <h4>From bands, to mugs, to laptop skins. Customize yourself with all these goodies!</h4>
  <br><br>
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="arsenalcup.jpg" alt="Training" class="img-responsive">
        <p><strong>ARSENAL MUG</strong></p>
        <p>Arsenal - English Premier club </p>
        <p>Show your love for Arsenal in everything you do, even if it's drinking a cup of coffee! </p>
        <p>Grab it for $9.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="pogbadab.jpg" alt="Training" class="img-responsive">
        <p><strong>POGBA DAB LAPTOP SKIN</strong></p>
        <p>Paul Pogba - Manchester United</p>
        <p>Do you like the Dab celebration? Put it on you laptop and dab!!</p>
        <br />
        <p>Grab it for $9.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="torresmobile.jpg" alt="Training" class="img-responsive">
        <p><strong>TORRES - MOBILE COVER</strong></p>
        <p>Fernando Torres - Atletico Madrid</p>
        <p>Get your mobile covered by EL Nino</p>
        <br />
        <p>Grab it for $9.99</p>
      </div>
    </div>
...
<div class="row">
  ...
  <div class="col-sm-4 form-group">
                    <form action ="comment.php?product=accessories" method="POST">
...
<center>
  ...
  $sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='accessories' and t.product ='accessories'";
 ...
 $sql1 = "SELECT user FROM products_visited  where product ='accessories' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'accessories',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='accessories' and user = '".$login_session."'" ;    
