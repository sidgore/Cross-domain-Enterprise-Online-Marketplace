  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'cleats'},function(d){
                                    if(d>0)
                                    {
...
<div id="cleats"  class="container-fluid text-center formfont bg-grey ">
  ...
  <h2>CLEATS</h2>
  <h4>You need to have the cleats of your idol!</h4>
  <br><br>
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="ronaldocleats.jpg" alt="Training" class="img-responsive">
        <p><strong>NIKE MERCURIAL CR7</strong></p>
        <p>Nike - Superfly CR7 boots</p>
        <p>Designed for speed and rocket of a shot.</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="messicleats.jpg" alt="Training" class="img-responsive">
        <p><strong>ADIDAS MESSI 16</strong></p>
        <p>Adidas - Messi 16 Pureagility Silver Metallic</p>
        <p>Designed for ultimate agility and control</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="pumacleats.jpg" alt="Training" class="img-responsive">
        <p><strong>PUMA evoPOWER</strong></p>
        <p>The all new Puma football boots</p>
        <p>Designed for balance for the trickster in you</p>
        <p>Grab it for $99.99</p>
      </div>
    </div>
</div>
...
<div class="row">
  ...
  <div class="col-sm-4 form-group">
                    <form action ="comment.php?product=cleats" method="POST">
...
<center>
  ...
  $sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='cleats' and t.product ='cleats'";
 ...
 $sql1 = "SELECT user FROM products_visited  where product ='cleats' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'cleats',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='cleats' and user = '".$login_session."'" ;    
