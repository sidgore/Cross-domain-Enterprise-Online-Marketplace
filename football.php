  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'football'},function(d){
                                    if(d>0)
                                    {
...
<div class="container">
	<section>
     ...
     <p>Hello <?php echo $login_session; ?>, you have seen this page <?php echo $_SESSION['count']; ?> times.
			...
			<p>
			<h2><code>Football-Scout<span class="glyphicon glyphicon-fire"></span></h2></code> </p><br>
			<p class="bg-danger"> Find your new recruit just like the moneyball! 
			</p>	</h2></p></p></blockquote>
			<img src="scout.jpg" class="img-thumbnail" alt="Responsive image">
        <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=football" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='football' and t.product ='football'";
...
$sql1 = "SELECT user FROM products_visited  where product ='football' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'football',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='football' and user = '".$login_session."'" ;    
