  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'Citylight'},function(d){
                                    if(d>0)
                                    {
...
<div class="container">
	<section>
     ...
     <p>Hello <?php echo $login_session; ?>, you have seen this page <?php echo $_SESSION['count']; ?> times.
			...
			<h2><code>City-light<span class="glyphicon glyphicon-fire"></span></h2></code> </p><br>
			<p class="bg-danger"> Analysis of the growing suburbia and urban planning trends around the world.
			</p>	</h2></p></p></blockquote>
			<img src="city.jpg" class="img-fluid" alt="Responsive image">
			       <!-- ad1 start -->
...
<div style='clear:both;'></div>
                ...
                <form action ="comment.php?product=Citylight" method="POST">
...
$sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='Citylight' and t.product ='Citylight'";
...
$sql1 = "SELECT user FROM products_visited  where product ='Citylight' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'Citylight',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='Citylight' and user = '".$login_session."'" ;    
