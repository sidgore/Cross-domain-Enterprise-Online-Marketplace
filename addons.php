  ...
  <script>
                        $(document).ready(function () {
                            $("#demo3 .stars").click(function () {
                                ...
                                $.post('rating.php',{rate:$(this).val(),product: 'addons'},function(d){
                                    if(d>0)
                                    {
...
<div id="addons"  class="container-fluid text-center formfont bg-grey ">
  ...
  <h2>ADD ONS</h2>
  <h4>From gloves to stockings to wristbands. You get them all here.</h4>
  <br><br>
  <div class="row text-center">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="gloves.jpg" alt="Training" class="img-responsive">
        <p><strong>ADIDAS GOALIE GLOVES</strong></p>
        <p>Adidas Goalie Gloves have been relied on by the world's best. </p>
        <p>Latest technology used to provide the best grip, lessen impact and for durability </p>
        <p>Grab it for $59.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="stockings.jpg" alt="Training" class="img-responsive">
        <p><strong>FOOTBALL STOCKINGS</strong></p>
        <p>Manchester United Football stockings</p>
        <p>Very good Fabric Quality Made of Nylon, Dry Fit</p>
        <p>Grab it for $9.99</p>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="brazil.jpg" alt="Training" class="img-responsive">
        <p><strong>BRAZIL NATIONAL TEAM SCARF</strong></p>
        <p>Show your support to the Country where football is worshipped</p>
        <p>Acrylic knitted, double sided winter scarf</p>
...
<div class="row">
  ...
  <div class="col-sm-4 form-group">
                    <form action ="comment.php?product=addons" method="POST">
...
<center>
  ...
  $sql = "SELECT c.*, t.* FROM comment c, tbl_rating t where c.user = t.user_id and c.product ='addons' and t.product ='addons'";
 ...
 $sql1 = "SELECT user FROM products_visited  where product ='addons' and user = '".$login_session."'" ;
 $sql2 = "INSERT INTO `products_visited` ( `user`, `product`, `counts` ) VALUES ('" . $login_session . "', 'addons',  1); ";
 $sql3= "UPDATE `products_visited` SET counts=counts+1 where product='addons' and user = '".$login_session."'" ;    
